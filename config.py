...
OWNER_USERNAME = getenv("OWNER_USERNAME","Hawaall")
USER_OWNER = getenv("USER_OWNER","Hawaall")
...
EVALOP = list(map(int, getenv("EVALOP", "833360381 1818734394 6588787990").split()))
# Get your mongo url from cloud.mongodb.com
MONGO_DB_URI = getenv("MONGO_DB_URI", None)

DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", "9999999999990"))

SONG_DOWNLOAD_DURATION = int(getenv("SONG_DOWNLOAD_DURATION", "999999999999"))
...
OWNER_ID = list(map(int, getenv("OWNER_ID", "833360381 6588787990").split()))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/cjrcrc443/bjcgccjccf",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Haawall")
