    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**⇜ تێل نەکراوەتەوە لە گرووپ\nدڵنیابەوە کە تێل کراوەتەوە\nئەگەر تێل کراوەتەوە تازەی بکەوە بە /restart\nبۆ بانگکردنی یاریدەدەر : /userbotjoin ⎋**"
                )

        except AlreadyJoinedError:
            raise AssistantErr(
                "**⇜ یاریدەدەر  لەتێلە\n\n\سیستەمی بۆتی گۆرانی دۆزرایەوە کە یاریدەدەرەکە پێشتر لە تێلدایە، ئەگەر کێشەکە بەردەوام بوو تێلەکە دووبارە نوێ بکەوە و هەوڵبدەرەوە ⎋**"
            )
        except TelegramServerError:
            raise AssistantErr(
                "**⇜ هەڵەیەك لە سێرڤەری تێلەگرام\n\nتکایە تێل دابخە و دووبارە دەستپێبکەوە ⎋**"
            )
