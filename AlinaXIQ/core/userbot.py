...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("IQQUR")
                await self.one.join_chat("Haawall")
                await self.one.join_chat("MGIMT")
                await self.one.join_chat("GroupAlina")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("IQMUC")
                await self.three.join_chat("IQQUR")
                await self.three.join_chat("MGIMT")
                await self.three.join_chat("EHS4SS")
                await self.three.join_chat("GroupAlina")
        ...
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("IQQUR")
                await self.four.join_chat("XV7AMO")
                await self.four.join_chat("EHS4SS")
                await self.four.join_chat("GroupAlina")
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("GroupAlina")
