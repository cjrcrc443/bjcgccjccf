...
async def music(client: Client, message: Message):
    ...
    await client.send_voice(message.chat.id, url, caption="**[⧉• 𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝙖𝙬𝙖𝙡 - 🧑🏻‍💻🖤 گۆرانی](t.me/Haawall)**\n\n**••┉┉┉┉┉••🝢••┉┉┉┉┉••**\n**¦  گۆرانییەکانم➧♥️**\n**@Haawall - کەناڵی گۆرانی**",
...
async def ihd(client: Client, message: Message):
    ...
    await client.send_photo(message.chat.id,url,caption="**[⧉• 𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝙖𝙬𝙖𝙡 - 🧑🏻‍💻🖤 وێنەکان](t.me/Haawall)**\n**••┉┉┉┉┉••🝢••┉┉┉┉┉••**\n\n**¦ وێنەکە دیاریکرا ♥•**",
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def ihd(client: Client, message: Message):
    ...
    await client.send_photo(message.chat.id,url,caption="**[⧉• 𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝙖𝙬𝙖𝙡 - 🧑🏻‍💻🖤 کچان](t.me/Haawall)**\n**••┉┉┉┉┉••🝢••┉┉┉┉┉••**\n\n**¦ وێنەی کچان➧♥️\n@Haawall - کەناڵی وێنە**",
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def voice(client: Client, message: Message):
    ...
    await client.send_voice(message.chat.id, url, caption="**[⧉• 𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝙖𝙬𝙖𝙡 - 🧑🏻‍💻🖤 قورئان](t.me/Haawall)**\n**••┉┉┉┉┉••🝢••┉┉┉┉┉••**\n\n**¦ قورئانی پیرۆز➧♥️\n@Haawall - کەناڵی قورئان**",
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
async def video(client: Client, message: Message):
    ...
    if u.video:
     await client.send_video(message.chat.id, u.video.file_id, caption="**[⧉• 𝙎𝙊𝙐𝙍𝘾𝞝 𝙃𝙖𝙬𝙖𝙡 - 🧑🏻‍💻🖤 ڤیدیۆ](t.me/Haawall)**\n**••┉┉┉┉┉••🝢••┉┉┉┉┉••**\n\n**¦ @Haawall - کەناڵی ڤیدیۆ♥️•**",
    reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
